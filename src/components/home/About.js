...
const About = () => {
  return (
    <div className="w-4/5 mx-auto mb-8 text-center" id="about">
      ...
      >
        Our platform provides a secure and convenient way to secure the Student Data.
         We prioritize security and privacy, ensuring that
      ...
      >
        ...
        peace of mind knowing that your Data are in safe hands.
      </p>

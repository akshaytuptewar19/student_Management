    ...
    try {
      ...
      if (account) {
        ...
        if (accountType === "government" && account !== gov.toLowerCase()) {
          setloading(false);
          return toast.error("Please Sign In Through Adminstration Account");
        }
        if (accountType === "officer" && !mainOffs.includes(account)) {
          setloading(false);
          return toast.error("Please Sign In Through Teacher Account");
        }
        if (
          accountType === "user" &&
    ...
    <div className="bg-[#f4f4f4] w-full rounded shadow-md pt-1">
      ...
      <div className="grid grid-cols-3 gap-5 w-full p-4 mt-8">
        <div className="bg-white rounded-2xl p-4 flex flex-col justify-center items-center shadow-md">
          ...
          <p className="text-2xl font-bold my-2">Adminstration</p>
          <button
        ...
        <div className="bg-white rounded-2xl p-4 flex flex-col justify-center items-center shadow-md">
          ...
          <p className="text-2xl font-bold my-2">Teacher</p>
          <button
            className="border-none outline-none px-6 py-2 text-white text-xl rounded cursor-pointer flex items-center justify-center"
            style={{ background: "rgb(34, 15, 104)" }}
        ...
        <div className="bg-white rounded-2xl p-4 flex flex-col justify-center items-center shadow-md">
          ...
          <p className="text-2xl font-bold my-2">Student</p>
          <button
            className="border-none outline-none px-6 py-2 text-white text-xl rounded cursor-pointer flex items-center justify-center"
            style={{ background: "rgb(34, 15, 104)" }}
      ...
      <li className="mb-2">Adminstration is the final controlling authority</li>
        <li className="mb-2">Adminstration can add Teacher</li>
        <li className="mb-2">Teacher validates all User</li>
        <li className="mb-2">
